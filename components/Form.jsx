...
const Form = ({type, post, setPost, submit, handleSubmit }) => {
  return (
      ...
      <section className='w-full md:max-w-full flex-start flex-col mb-12'>
          ...
          <form onSubmit={handleSubmit} className='mt-10 w-full md:max-w-2xl flex-col flex gap-6 glassmorphism'>
              <label>
